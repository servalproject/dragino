...
# add the specific dragino packages as a feed
echo "src-link dragino $REPO_PATH/package" > $BACKFIRE_PATH/feeds.conf
$BACKFIRE_PATH/scripts/feeds update
$BACKFIRE_PATH/scripts/feeds install -a -p dragino

# add dragino pacakges as a feed
#echo "src-link dragino $REPO_PATH/package" > $BACKFIRE_PATH/feeds.conf
#$BACKFIRE_PATH/scripts/feeds update
#$BACKFIRE_PATH/scripts/feeds install -a -p dragino
...
# and then build the firmware for Dragino...
echo 
echo " ================================================= "
echo " To compile this custom Backfire build for Dragino "
...
echo
echo " To upload the firmware to the Dragino board after "
echo " compilation, type make flash V=99. Then connect   "
echo " the Dragino to your machine via ethernet and      "
echo " power it up.                                      "
echo
echo " Happy hacking!                                    "
echo " ================================================= "
